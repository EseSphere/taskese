...
include_once('./back_ends/forgot_password_backend.php');
?>
            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <h5 class="text-light">Forgot Password</h5>
                    </div>
                    <form action="" method="post" enctype="multipart/form-data" autocomplete="off" id="signupform">
                        ...
                        <button type="submit" name="forgotPs" class="btn btn-primary py-3 w-100 mb-4">Continue</button>
